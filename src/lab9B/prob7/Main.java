...
public class Main {
    ...
    public static void main(String[] args) {
        List<Integer> intList = Arrays.asList(4, 1, 5, -2, 0, -3, -1, -5, -4);
    ...
    public static void ordering1(List<Integer> list) {
        List<Integer> result = list.stream()
                .sorted(Comparator.comparing((Integer num) -> Math.abs(num)).thenComparing((Integer num1) -> num1))
                .toList();
    ...
    public static void ordering2(List<String> words) {
        List<String> result = words.stream()
                .sorted(Comparator.comparing((String w) -> new StringBuilder(w).reverse()))
                .toList();
